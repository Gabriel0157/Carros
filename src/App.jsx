    ...
    <main>
      <section>
        ...
        <div className="bg-green">
          ...
          <p className="font-lexend">Ecolha um SUV pelo seu interior espaçoso, poder e versatilidade. Perfeito para passar as férias em família ou para aventuras off-road</p>
        ...
        <div className="bg-dark-green">
          ...
          <p className="font-lexend">Passeie nos melhores carros os preços exorbitantes. Desfrute do conforto aprimorado de um aluguel de luxo e chegue com estilo.</p>
